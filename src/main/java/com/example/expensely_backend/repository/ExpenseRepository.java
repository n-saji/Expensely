...
public interface ExpenseRepository extends JpaRepository<Expense, UUID> {
    ...
    @Query("SELECT e from Expense e where e.user.id = :userId and e.expenseDate >= :startDate " +
            "and e.expenseDate < :endDate and e.category.id = :categoryId and e.description ILIKE :q " +
            "order by e.expenseDate DESC limit :limit offset :offset")
    ...
    @Query("SELECT e from Expense e where e.user.id = :userId and e.expenseDate >= :startDate " +
            "and e.expenseDate < :endDate and e.category.id = :categoryId and e.description ILIKE :q " +
            "order by e.expenseDate ASC limit :limit offset :offset")
    ...
    @Query("SELECT e from Expense e where e.user.id = :userId and e.expenseDate >= :startDate " +
            "and e.expenseDate < :endDate and e.description ILIKE :q " +
            "order by e.expenseDate DESC limit :limit offset :offset")
    ...
    @Query("SELECT e from Expense e where e.user.id = :userId and e.expenseDate >= :startDate " +
            "and e.expenseDate < :endDate and e.description ILIKE :q order by e.expenseDate ASC limit :limit offset :offset")
    ...
    @Query("SELECT count(e) from Expense e where e.user.id = :userId and e.expenseDate >= :startDate " +
            "and e.expenseDate < :endDate and e.category.id = :categoryId and e.description ILIKE :q")
